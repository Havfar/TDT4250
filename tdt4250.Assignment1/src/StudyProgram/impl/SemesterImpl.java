 ...
 *   <li>{@link StudyProgram.impl.SemesterImpl#getSeason <em>Season</em>}</li>
 *   <li>{@link StudyProgram.impl.SemesterImpl#getCourses <em>Courses</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SemesterImpl extends MinimalEObjectImpl.Container implements Semester {
	 ...
	 * @ordered
	 */
	protected EList<CourseElement> courses;
	...
	public void setYear(int newYear) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StudyProgramPackage.SEMESTER__YEAR, oldYear, year));
	}
	 ...
	 * @generated
	 */
	public EList<CourseElement> getCourses() {
		if (courses == null) {
			courses = new EObjectContainmentEList<CourseElement>(CourseElement.class, this, StudyProgramPackage.SEMESTER__COURSES);
		}
		return courses;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case StudyProgramPackage.SEMESTER__COURSES:
				getCourses().clear();
				getCourses().addAll((Collection<? extends CourseElement>)newValue);
				return;
		}
